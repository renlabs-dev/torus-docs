...
<Aside>⏱️ **Estimated time to complete this guide: 4 minutes**</Aside>
...
4. **Sign both transactions in MetaMask**  
   ...
   <Aside type="caution">
     Always verify transaction details before signing. Ensure you have enough
     funds in your MetaMask wallet to cover both transaction fees.
   </Aside>
