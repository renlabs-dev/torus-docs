...
1. **Visit the [Create Permissions tab in the Torus Portal](https://torus.network/permissions/create-permission/emission)**    
...
6. **All Done**  
   Your Emission Permission is now delegated. You can check it in the [Management tab](https://torus.network/permissions/edit-permission).
</Steps>
