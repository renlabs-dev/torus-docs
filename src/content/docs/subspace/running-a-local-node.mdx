...
description: Subspace allows you to run a local node for development and testing purposes. This guide will walk you through the process of setting up a local node.
---
...
<Steps>
    ...
    1. **Clone the Repository**:
        ...
        Open a terminal and run:
            ```sh
            git clone https://github.com/ren-labs/torus-blockchain
            ```
