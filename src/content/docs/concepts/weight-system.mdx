...
See [Yuma Consensus](/subspace/yuma-consensus).
...
<LinkButton href="/subnets/yuma-subnets">Yuma Subnets</LinkButton>
<LinkButton href="/subnets/general-subnet" variant="secondary">
  General Subnet
</LinkButton>
