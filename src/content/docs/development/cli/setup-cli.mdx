...
<CardGrid>
  <Card title="System Requirements" icon="seti:config">
    Choose your installation method based on your system setup: - **Python
    users**: [Python 3.10+](https://www.python.org/) and
    [pip](https://pip.pypa.io/en/stable/installation/) - **Nix users**: [Nix
...
4.  **Set up shell completions (optional)**  
    ...
    <Aside type="tip">
      Restart your terminal or run `source ~/.bashrc` (or `source ~/.zshrc`) to
