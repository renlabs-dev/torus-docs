...
Both the **Registered Agent** and **Root Agent** can edit their information. Just make sure to use the propper filter on the Allocator Page.  
On this Guide we will be editing the information of a **Registered Agent**.
...
## Support and Resources
   If you want to understand more about what is a Registered Agent or Root Agent, you can relate to the [Concepts & Terminology](https://docs.torus.network/getting-started/concepts/) section.  
