...
#### Why create an emission proposal?

Emission proposals let the community adjust how fees and emissions are allocated among:
- Recycling mechanisms  
- The network treasury  
- Incentive programs  

<Aside>
- Proposals **require community voting** before taking effect  
- Only approved proposals change the on‑chain emission distribution  
- Have a clear economic rationale and community support before submitting  
</Aside>

#### What we will accomplish

- Create and submit an emission proposal through the DAO interface  
- Set recycling, treasury and incentive percentages  
- Start the community voting process  
