---
title: Manage your Agent information
...
Both the **Registered Agent** and **Root Agent** can manage their information. <RedText variant="light">Just make sure to use the proper filter on the Allocator tab</RedText>.  
...
- Manage your Agent's description and technical details
