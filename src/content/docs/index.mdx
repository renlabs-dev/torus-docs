...
The mainnet, launched on January 3rd, represents a minimal implementation, enabling Torus to coordinate and incentivize the development and integration of agents, libraries, and tools. It remains fully agnostic to their substrate, design, and function. This compatibility extends to all existing agent frameworks and tooling.

The mainnet marks the early ecosystem growth period while the v1 Torus architecture is under development.
