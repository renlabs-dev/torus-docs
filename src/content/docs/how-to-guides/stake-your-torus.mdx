...
1. **Go to the [Staking tab in the Torus Wallet App](https://wallet.torus.network/staking)**   
   ...
   <Image src={walletStakingTab} alt="Staking tab in the Torus Wallet App" width="1920" />

2. **Connect your Torus Wallet**  
   Click the **Connect Wallet** button at the top right and select your Torus wallet.  
   <Image src={connectToWallet} alt="Connect your Torus Wallet" width="1920" />
...
4. **Fill in the required fields and confirm**  
   ...
   <Image src={fillInInformation} alt="Stake your Torus" width="1920" />
...
5. **Open SubWallet and Sign the Transaction**    
    ...
    <Image src={openSubwalletAndSign} alt="SubWallet sign transaction" width="1920" />
...
6. **Your Torus is now staked, but you must allocate to an Agent**
   ...
   <Image src={stakedBalanceSuccessfully} alt="Staked Balance" width="1920" />
</Steps>
...
1. **Open the [Torus Allocator App](https://allocator.torus.network/)**  
   ...
   <Image src={allocatorAppCardExplanation} alt="Torus Allocator App" width="1920" />
...
2. **Choose the agents to allocate**  
   ...
   <Image src={allocatorChooseWhoToAllocateTo} alt="Allocator-choose-who-to-allocate-to" width="1920" />
...
3. **Open the Allocation Menu and Confirm**    
   ...
   <Image src={allocatorConfirmAllocationAndSubmit} alt="Allocator-confirm-allocation-and-submit" width="1920" />
...
4. **Sign the Transaction in the SubWallet**    
   ...
   Click in the SubWallet icon at the top right navigation bar of your browser.   
   It will open a modal with the confirmation to sign the transaction.  
   <Image src={allocatorConfirmAndSignTransaction} alt="SubWallet sign transaction" width="1920" />
...
5. **All done!**
   ...
   <Image src={allocatorDoneAllocated} alt="allocator-done-allocated" width="1920" />
</Steps>
   <Aside>
