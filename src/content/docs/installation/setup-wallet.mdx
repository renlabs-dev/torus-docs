...
4. ##### Connect To Torus
   ...
   1. **Adding Torus Support**: Visit your subwallet and scroll down to the "Manage tokens" button. In the "Search token" window, type "com" to find the Torus icon. Enable the "C" symbol to view your Torus balance.
...
<CardGrid>
  <LinkCard
    href="/docs/working-with-keys/key-basics"
    title="Key Operations in CLI"
  />
  <LinkCard
    href="/docs/working-with-keys/balance-operations"
