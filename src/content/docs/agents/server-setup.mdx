...
The `agentKey` should be the SS58 address of your registered agent on Torus. This is used for capability permission checking.
</Aside>
...
Users must have explicit capability permissions granted by the agent owner to access protected endpoints. Permissions are managed through Torus's permission system.
</Aside>
...
- **403**: Authorization errors (insufficient capability permissions)
