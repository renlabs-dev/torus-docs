...
If you prefer to start with the theory first, begin with [Control Space](https://dev.docs.torus.network/v05/control-space/) and continue from there.   
...
- [Bridge from Base to Torus](https://docs.torus.network/how-to-guides/bridge-to-base/)
...
- Create a Signal _(coming soon)_
