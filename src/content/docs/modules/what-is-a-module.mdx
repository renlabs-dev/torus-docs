...
description: Learn what a module is in the Torus Network.
---

import { CardGrid, LinkCard } from "@astrojs/starlight/components";

Module is the most general term for an active entity in the Torus protocol.
...
<CardGrid>
  <LinkCard
    title="Miner Implementation"
    href="/docs/mining/create-miner"
    description="To learn about miner implementation read Create a Miner."
  />
  <LinkCard
    title="Validator Implementation"
    href="/docs/validating/create-validator"
    description="To learn about validator implementation read Create a Validator."
  />
</CardGrid>
