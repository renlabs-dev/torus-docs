---
title: What is Validating?
description: Learn about validating on the Torus Network and how it functions.
---

Validating in Torus means having a registered key with stake that is sending requests to miners to score their outputs on a offchain validation system to evaluate the relative value of each miner and calculate their weights.
