...
<CardGrid>
  ...
  <Card title="Registered Agent" icon="seti:license">
    You need a registered or whitelisted agent with access to its mnemonic
    phrase for authentication.
  </Card>
</CardGrid>
...
<Aside type="tip" title="Want to Learn More?">
  Learn about [agent
  client](https://docs.torus.network/explanations/builders/agent-client/)
