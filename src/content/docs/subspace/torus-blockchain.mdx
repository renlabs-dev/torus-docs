---
title: Torus Blockchain
description: Torus is a blockchain that is designed to be a scalable, high-performance, and secure blockchain that is a optimized Subspace Network.
---

Torus's blockchain **Subspace**, is built on top of the [Rust Substrate](https://docs-substrate-io.translate.goog/learn/rust-basics/?_x_tr_sl=en&_x_tr_tl=cs&_x_tr_hl=cs&_x_tr_pto=sc) framework.
...
- Connect To Mainnet: _`wss://api.torus.network`_
- Connect To Testnet: _`wss://testnet.api.torus.network`_

## Installation

1. Complete the [basic Rust setup instructions](https://github.com/renlabs-dev/subspace-network/blob/main/rust-setup.md).
