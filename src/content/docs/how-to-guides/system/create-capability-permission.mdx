...
<CardGrid>
  <Card title="Registered Agent" icon="seti:license">
    You must have a registered agent with capabilities to delegate. Follow the
    [manage permissions
    guide](https://docs.torus.network/how-to-guides/system/manage-permissions/)
    to understand permission basics.
  </Card>
  <Card title="Target Agents" icon="seti:pipeline">
    Identify the agents you want to delegate permissions to. These agents must
    be registered.
  </Card>
...
- Your own path PLUS another path that you have instances for
   ...
   <ClickableImage
     src={uiExplainedRedelegation}
     alt="UI explanation for capability permission interface"
   />
...
**Automatic Path Inheritance**
   ...
   <ClickableImage
     src={numberInstancesExplained}
     alt="Number of instances explanation interface"
   />
