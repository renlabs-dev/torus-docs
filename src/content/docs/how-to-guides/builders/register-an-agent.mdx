...
3.  **Fill in your agent details**  
    ...
    <Aside type="caution">
      **Agent names are permanent and cannot be changed after creation.** Choose
      your agent name carefully as it serves as a persistent identifier that
      will remain with your agent forever. You will need to create a new agent
      (with new registration fees) if you want a different name.
    </Aside>
...
<Aside type="tip" title="Want to Learn More?">
  Learn about [agent
  registration](https://docs.torus.network/explanations/builders/agent-registration/)
  economics, burn mechanisms, and discovery.
</Aside>
