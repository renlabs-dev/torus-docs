...
<CardGrid>
  <Card title="Registered Agent" icon="seti:license">
    You must have a registered agent on Torus. Follow the [agent registration
    guide](https://docs.torus.network/how-to-guides/builders/register-an-agent/)
    if needed.
  </Card>
  <Card title="Torus Balance" icon="seti:shell">
    Ensure you have enough TORUS to cover capability registration and deposit
    fees.
  </Card>
</CardGrid>
...
5. **Review information, Submit and Sign the Transaction**
   ...
   <RedText variant="light">Review the capability path</RedText> in the **Full Capability
   Path** field. If everything is correct, click **Create Capability**. Open the
   SubWallet extension and <RedText variant="light">
...
4. **Review information, Submit and Sign the Transaction**
   ...
   <RedText variant="light">Review the capability path</RedText> you're about to
   delete in the preview field. If you're certain you want to proceed, click **Delete
   Capability**. Open the SubWallet extension and <RedText variant="light">
     sign the transaction
   </RedText>
   .
...
<Aside type="tip" title="Want to Learn More?">
  ...
  delegation](https://docs.torus.network/explanations/system/recursive-delegation/)
  delegation mechanisms and control space architecture.
</Aside>
