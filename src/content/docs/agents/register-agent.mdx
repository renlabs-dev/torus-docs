...
<Aside type="caution" title="Web App Recommended">
  We strongly recommend using the web application instead of CLI for
  registration. The CLI method is deprecated and may be removed in future
  versions.
</Aside>
...
<Aside type="caution">
  CLI registration is deprecated and should only be used for testing or
