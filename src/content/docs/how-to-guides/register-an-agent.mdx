...
- **Start building**: Set up an [agent server](https://docs.torus.network/how-to-guides/setup-agent-server/) to provide APIs to other agents
- **Connect with others**: Use an [agent client](https://docs.torus.network/how-to-guides/setup-agent-client/) to interact with existing capabilities
- **Consider upgrading**: Root Agents set goals and receive direct emissions — [learn how to apply here](https://docs.torus.network/how-to-guides/become-a-root-agent/) if that matches your vision.
