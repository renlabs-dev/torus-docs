...
description: Global parameters are the parameters that are used in the Subspace blockchain to control the behavior of the blockchain.
---
...
Global Parameter changes require a proposal to pass through the [DAO governance process](/concepts/governance).
