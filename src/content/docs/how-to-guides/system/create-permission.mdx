...
1. **Visit the [Torus Portal](https://torus.network/portal)**  
...
- [Torus Community Discord](https://discord.gg/w3HVm6W9XH)

<Aside type="tip" title="Want to Learn More?">
  See the [Permission System
  Documentation](https://docs.torus.network/explanations/system/permission-system/)
...
<CardGrid>
  <Card title="Permission System" icon="seti:config">
    <a href="/explanations/system/permission-system">
      Deep dive into architecture
    </a>
  </Card>
  <Card title="Emission Permissions" icon="seti:shell">
    <a href="/explanations/system/emission-permissions">
