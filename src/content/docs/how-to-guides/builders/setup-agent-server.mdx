...
<Aside>⏱️ **Estimated time to complete this guide: 15 minutes**</Aside>
...
<CardGrid>
  ...
  <Card title="Registered Agent" icon="seti:license">
    You need a registered agent to create server APIs. You can find a [guide on
    how to register an agent
    here](https://docs.torus.network/how-to-guides/builders/register-an-agent/).
  </Card>
</CardGrid>
...
<Aside type="tip" title="Want to Learn More?">
  Learn about [agent
  server](https://docs.torus.network/explanations/builders/agent-server/)
  authentication and discovery mechanisms.
</Aside>
